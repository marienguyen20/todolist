...
def updating_record():
    ...
    for task in tasks:
        WorkingList.insert("end", "" + task[0] + "============> Time Left: " + str(task))
...
if __name__ == '__main__':
    ...
    #widgets
    lbl = tkinter.Label(root, text="Enter Tasks To Do:", fg="white", bg="red",
                    font=('Arial', 14), wraplength=200)
    bl_hrs = tkinter.Label(root, text="Enter time (Seconds)", fg="white",
                        bg="red", font=('Arial', 14), wraplength=200)
